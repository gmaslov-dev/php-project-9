...
В проекте используется удобный Makefile, который ускоряет ежедневную разработку и избавляет от длинных команд.
...
| Команда       | Действие                                                     |
|---------------|--------------------------------------------------------------|
| `make start`  | Запуск встроенного PHP-сервера на `PORT` (по умолчанию 8000) |
| `make install`| Установка зависимостей через Composer                        |
